...
Group:     Development/Libraries
Requires:  mysql++ = %{version}-%{release}, mariadb-devel
...
%changelog
* Wed Apr 28 2021 Warren Young <mysqlpp@etr-usa.com> 3.3.0-1
- Changed dependency on mysql-devel to mariadb-devel, now that our build
  systems no longer ship that as a compatibility RPM.
